...
<html>
    <head>
        ...
        <title>SensorWays IoT Home Page</title>
...
<% } %>
        ...
        <form method="post" action="Login">
            <table>
                <tr><td>&nbsp;Plenty of IoT devices are available for selection plus ability to customize any devices based on user's requirements</td></tr>
                <tr><td></td><td></td></tr>
<% if(session.getAttribute("USER")==null) { %>            
